...
// src/ui/components/InputFieldComponent.ts
var import_obsidian2 = require("obsidian");
var InputFieldComponent = class extends import_obsidian2.TextComponent {
  ...
  render() {
    ...
    if ((_a = this.options) == null ? void 0 : _a.description) {
      this.descriptionEl = this.createDescriptionEl(this.contentEl, this.options.description);
    }
...
var ReviewView = class extends RecallSubView {
  ...
  renderAnswerButtons() {
    ...
    const exitButton = new import_obsidian5.ButtonComponent(this.answerButtonsBarEl);
    ...
    this.showAnswerButton = new import_obsidian5.ButtonComponent(this.answerButtonsBarEl).setCta();
  ...
  renderButton(performanceResponse, emoji, text) {
    ...
    const button = new import_obsidian5.ButtonComponent(this.recallButtonsBarEl);
...
var EditDeckModal = class extends import_obsidian6.Modal {
  ...
  render() {
    ...
    const deleteButton = new import_obsidian6.ButtonComponent(buttonsContainer).setButtonText("Delete").onClick(() => this.deleteDeck());
...
var EditCardModal = class extends CardModal {
  ...
  render() {
    ...
    const buttonsContainer = this.contentEl.createDiv("better-recall__buttons-container");
    const deleteButton = new import_obsidian7.ButtonComponent(buttonsContainer).setButtonText("Delete").onClick(() => this.deleteCard());
    deleteButton.buttonEl.addClass("better-recall-delete-button");
...
var EditCardsModal = class extends import_obsidian8.Modal {
  constructor(plugin, deck) {
    super(plugin.app);
    this.plugin = plugin;
    this.deck = deck;
...
var DecksView = class extends RecallSubView {
  ...
  renderDeckButtons(root, deck) {
    ...
    const walletCardsIcon = (0, import_obsidian9.getIcon)("wallet-cards");
    if (walletCardsIcon) {
    ...
    const penIcon = (0, import_obsidian9.getIcon)("pen");
    if (penIcon) {
  ...
  renderButtons() {
    ...
    new import_obsidian9.ButtonComponent(buttonsBarEl).setButtonText("Create Deck").onClick(this.openDeckModal.bind(this));
    new import_obsidian9.ButtonComponent(buttonsBarEl).setButtonText("Add card").setCta().onClick(() => {
      new AddCardModal(this.plugin).open();
    });
  }
  onClose() {
...
var RecallView = class extends import_obsidian10.FileView {
...
var ResetButtonComponent = class extends import_obsidian11.ButtonComponent {
  constructor(contentEl) {
    super(contentEl);
    this.contentEl = contentEl;
...
var SettingsTab = class extends import_obsidian12.PluginSettingTab {
  ...
  display() {
    ...
    Object.entries(this.titleParameterMapping).forEach(([key, { parameter, description }]) => {
      ...
      const setting = new import_obsidian12.Setting(this.containerEl).setName(key).setDesc(description);
...
// src/main.ts
var BetterRecallPlugin = class extends import_obsidian13.Plugin {
  constructor() {
    super(...arguments);
